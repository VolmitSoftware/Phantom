...
import art.arcane.phantom.core.service.PhantomTickService;
...
public abstract class TickedObject implements Ticked {
    ...
    public TickedObject(String group, String id, long interval) {
        ...
        Phantom.get(PhantomTickService.class).getTicker().register(this);
    }
    ...
    public void unregister() {
        Phantom.get(PhantomTickService.class).getTicker().unregister(this);
    }
