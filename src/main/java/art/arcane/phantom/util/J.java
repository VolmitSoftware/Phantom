...
public class J {
    ...
    public static <T, R> R attemptFunction(NastyFunction<T, R> r, T param, R onError) {
        try {
            ...
            Phantom.verbose("Failed to run function: " + e.getMessage());
        }
    ...
    public static void s(Runnable r) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(PhantomAPIPlugin.getInstance(), r);
    }
    ...
    public static void s(Runnable r, int delay) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(PhantomAPIPlugin.getInstance(), r, delay);
    }
    ...
    public static int sr(Runnable r, int interval) {
        return Bukkit.getScheduler().scheduleSyncRepeatingTask(PhantomAPIPlugin.getInstance(), r, 0, interval);
    }
    ...
    public static void a(Runnable r, int delay) {
        Bukkit.getScheduler().scheduleAsyncDelayedTask(PhantomAPIPlugin.getInstance(), r, delay);
    }
    ...
    public static int ar(Runnable r, int interval) {
        return Bukkit.getScheduler().scheduleAsyncRepeatingTask(PhantomAPIPlugin.getInstance(), r, 0, interval);
    }
